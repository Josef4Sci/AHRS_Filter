...
for i in range(4):
    b = PyVQF(1.0/dat['mean_sampling_rate'], tauAcc=1.1, tauMag=1.1, 
    ...
    b = PyVQF(1.0/dat['mean_sampling_rate'], tauAcc=1.1, tauMag=1.1, 
                motionBiasEstEnabled=False, restBiasEstEnabled=False, magDistRejectionEnabled=False,
                useJustaFilter=True, useAccLp=False)
...
print(f"Time taken VQF: {t_vqf} seconds")
print(f"Time taken Justa: {t_justa} seconds")
print(f"Time taken Base: {t_base} seconds")
