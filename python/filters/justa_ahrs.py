...
from quaternion_library_jit import fast_cross, integrate_midpoint, integrate_rk4, quaternion_rotate_vector, quatMultiply
...
class JustaAHRSv3:
    """
    Justa AHRS v3
    correction as in InvFast but delayed and weighted
    """
